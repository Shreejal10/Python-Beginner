...
#set the initial eqution to empty
equation = ""

#function to display the button pressed by the user in the output box
def show(value):
    global equation
    equation+=value
...
#funciton to calculate the equation
def calculate():
    global equation
    result = ""
    if equation != "":
